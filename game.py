...
if __name__ == '__main__':
    ...
    if Player.lives > 0:
        print('Let the trivia begin!')
    if Player.lives == 1:
        print('Slow down and think about your answers! You only have 1 life LEFT!')
    if Player.lives <= 0:
        print('GAME OVER! You have been defeated by the Fairy Princess.')
    ...
    if world == 'Burningdom':
        ...
        if q6 != 'Starving, smothering, cooling':
            ...
            print('Great job!')
        print('Thank you for playing! I hope you survived Buringdom. If your wisdom and ' +
              'intelligence were above 6, you should have survived.')
    ...
    if world == 'Demiworld':
        ...
        if q6 != 'Cerburus':
            ...
            print('Great job!')
        print('Thank you for playing! I hope you survived Demiworld. If your wisdom and ' +
              'intelligence were above 5, you should have survived.')
    ...
    if world == 'Fairyworld':
        ...
        if q3 != 'Greta Thunberg':
            ...
            print('Great job!')
        q4 = input('A major potential in efforts to engineer environmental sustainability ' + 
                   'is attempts to breed bacteria that can eat what polymer-based ' + 
                   'materials that are difficult to recycle?\n')
        if q4 != 'Plastic':
            print('ERr wrong answer')
        else:
            print('Great job!')
        q5 = input('The largest living species of tortoise in the world is native to ' + 
                   'what island archipelago in the Pacific Ocean?\n')
        if q5 != 'Galapagos':
            print('ERr wrong answer')
        else:
            print('Great job!')
        q6 = input('What is the three-letter acronym of the international organization ' + 
                   'established in 1961 whose purpose is environmentalism and ' + 
                   'conservation?\n')
        if q6 != 'WWF':
            print('ERr wrong answer')
        else:
            print('Great job!')
        print('Thank you for playing! I hope you survived Fairyworld. If your wisdom and ' +
              'intelligence were above 7, you should have survived.')
